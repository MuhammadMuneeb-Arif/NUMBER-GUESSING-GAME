...
if (a>ans){console.log("hint: Number is greater than the number you guess")}

 else{console.log("hint: Number is less than the number you guess")}
